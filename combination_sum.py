...
# an unlimited number of times. Two combinations are
...
class Solution(object):
    def combinationSum(self, candidates, target):
        for num in candidates:
            if num == 1 and target == 1:
                return [[1]]
            elif target == 1 and num > target:
                return []
            else:
                match = []
                complete = []
...
attempt1 = solution.combinationSum([1], 1)
attempt2 = solution.combinationSum([2], 1)
attempt3 = solution.combinationSum([1], 2)
attempt4 = solution.combinationSum([2,3,6,7], 7)
print(attempt1)
print(attempt2)
print(attempt3)
print(attempt4)
