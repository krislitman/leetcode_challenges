...
# On every subsequent Monday, he will put in $1
# more than the previous Monday.
# Given n, return the total amount of money he
# will have in the Leetcode bank at the end of the nth day.
...
bank = Solution()
# attempt1 = bank.totalMoney(n=4)
attempt2 = bank.totalMoney(n=10)
print(attempt2)
